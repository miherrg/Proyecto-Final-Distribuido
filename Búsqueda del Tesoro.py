        ...
        if rank == 0:
            ...
            for i in range(1,5):
                ...
                if current_loc == key_loc:
                    ...
                    print(f"Gana el equipo {winning_team}")
            ...
            while not legal_move:
                ...
                match direction:
                    ...
                    case _:
                        test_loc = (key_loc[0], key_loc[1] - 1)
                if max(test_loc) < 20 and min(test_loc) >= 0 and test_loc not in visited_by_team:
                    legal_move = True
                    key_loc = test_loc
            print(f"Proceso {rank}, nueva casilla {key_loc}")
            # Enviamos la nueva posición al nodo maestro para comprobar si hemos encontrado el tesoro.
